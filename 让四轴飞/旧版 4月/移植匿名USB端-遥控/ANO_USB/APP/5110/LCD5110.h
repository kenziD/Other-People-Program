...
/*------5110引脚动作宏定义-----------*/ 
#define bl1  GPIO_SetBits(GPIOB, GPIO_Pin_9)
#define bl0  GPIO_ResetBits(GPIOB, GPIO_Pin_9)

#define LCD_SCLK_H	GPIOA->BSRR = LCD_SCLK_BIT		//SCLK置1	
#define LCD_SCLK_L  GPIOA->BRR  = LCD_SCLK_BIT		//SCLK置0
